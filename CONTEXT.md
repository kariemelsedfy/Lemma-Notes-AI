...
features (which is Q12's problem, not T0's); mainland China is a real exclusion with a
Qwen-backed launch approved in July 2026 and reportedly no PCC. Both situations are live, so
§5.2 is a dated snapshot rather than a fact.
